...
# app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URI', 'mysql://root:Agr%40hari567%23@localhost/flask_data')
...
#             'payment_capture': '1'
#         })
#         print("Payment order created:", payment_order)  # Debug statement
#         return render_template('checkout.html', cart_items=cart_items, total_amount=total_amount, payment_order=payment_order)
...
#         return jsonify({'response': 'Authentication failed. Check your API key.'}), 401

#     except Exception as e:
#         return jsonify({'response': f'Sorry, I could not process your request at the moment. Error: {e}'}), 500
